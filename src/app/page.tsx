  ...
  return (
    <div>
      <section aria-label="Hero" className="relative min-h-[90vh] sm:min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-white to-emerald-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-16 sm:pb-24 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div>
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-primary/5 text-primary rounded-full text-xs sm:text-sm font-medium mb-6 sm:mb-8 border border-primary/10 animate-fade-in-up">
                <span className="w-2 h-2 bg-primary rounded-full mr-2 animate-pulse" />
                Trusted by leading organizations worldwide
              </div>
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-[1.1] mb-4 sm:mb-6 animate-fade-in-up">
      ...
      <section aria-label="Our impact in numbers" className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <span className="text-xs sm:text-sm font-semibold text-primary uppercase tracking-widest">By the Numbers</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {services.map((service, i) => (
              <div
                key={i}
                className="group relative bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 hover:border-primary/20 transition-all hover:shadow-xl hover:-translate-y-1"
              >
      ...
      <section aria-label="Testimonials" className="py-16 sm:py-24 bg-gradient-to-br from-primary-deeper via-primary-dark to-primary-deeper text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-10 sm:mb-16">
            <span className="text-xs sm:text-sm font-semibold text-accent uppercase tracking-widest">Testimonials</span>
